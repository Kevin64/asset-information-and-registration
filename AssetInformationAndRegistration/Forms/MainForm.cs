...
namespace AssetInformationAndRegistration.Forms
{
    ...
    internal partial class MainForm : Form, ITheming
    {
        ...
        private string serviceTypeURL, brand, model, serialNumber, processor, ram, storageSize, storageSummary, mediaOperationMode, videoCard, operatingSystem, hostname, macAddress, ipAddress, fwVersion, fwType, secureBoot, virtualizationTechnology, smartStatus, tpmVersion;
        ...
        private List<List<string>> storageDetail, storageType;
        ...
        private void InitializeComponent()
        {
            ...
            this.lblCompliant = new System.Windows.Forms.Label();
            ...
            this.groupBoxHwData.Controls.Add(this.lblCompliant);
            ...
            // lblCompliant
            // 
            resources.ApplyResources(this.lblCompliant, "lblCompliant");
            this.lblCompliant.ForeColor = System.Drawing.SystemColors.MenuHighlight;
            this.lblCompliant.Name = "lblCompliant";
            // 
            // vSeparator1
            // 
            ...
            this.lblLastService.ForeColor = System.Drawing.SystemColors.MenuHighlight;
        ...
        private async void Collecting()
        {
            ...
            else
            {
                ...
                lblServerIP.Text = lblServerPort.Text = lblAgentName.Text = lblServerOperationalStatus.Text = lblLastService.Text = Strings.OFFLINE_MODE_ACTIVATED;
                lblServerIP.ForeColor = lblServerPort.ForeColor = lblAgentName.ForeColor = lblServerOperationalStatus.ForeColor = lblLastService.ForeColor = StringsAndConstants.OFFLINE_ALERT;
            }
